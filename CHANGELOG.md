...
* Class123 names are no longer ordered alphabetically, and now follow a new specification as laid out in REFERENCE [#306](https://github.com/haml/haml/issues/306)
...
* Inline1 HTML text nodes are now transformed into inline Haml text.
